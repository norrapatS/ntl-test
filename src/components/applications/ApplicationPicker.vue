...
<template>
  <div class="flex flex-col gap-1.5 w-full">
    <label class="text-sm font-semibold text-gray-700 select-none">
      {{ label }}
    </label>
